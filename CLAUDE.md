...
Current wave: `bigdev/CONT-TODO.md` (**Wave 005: the admin dashboard**, spec `bigdev/plans/cont/03-ADMIN-DASHBOARD.md`, scope `bigdev/plans/cont/WAVE-005.md`). Wave specs + archive: `bigdev/plans/cont/`. Lessons: `bigdev/claude/lessons.md`.
