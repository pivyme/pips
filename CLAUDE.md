...
Current wave: `bigdev/CONT-TODO.md` (**Wave 006: five new games + the games lab**, spec `bigdev/plans/cont/04-GAMES-LAB.md`, designs `docs/games-ideation/`, scope `bigdev/plans/cont/WAVE-006.md`). Wave specs + archive: `bigdev/plans/cont/`. Lessons: `bigdev/claude/lessons.md`.
