...
// guts, on a dark bench. Debug mode keeps the tuning GUI handy and skips auth; isolated from /dev/console so the molded device stays default there.
export const Route = createFileRoute('/dev/console-transparent')({ component: ConsoleTransparentPage })
